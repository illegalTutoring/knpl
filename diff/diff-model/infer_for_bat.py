...
target_model_path = f"./checkpoint/{target_model}"
...
if __name__ == '__main__':
    ...
    model_path = f'./checkpoint/{project_name}/model_ckpt_steps_{target_model_max}.ckpt' # change ckpt file name to your best ckpt file name
    config_path = f'./checkpoint/{project_name}/config.yaml'
