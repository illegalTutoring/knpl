...
set ui_work_dir=checkpoint/%user_name%
echo.


:stt2
echo �ִ�� ������ CKPT(�н�����) ������ �Է����ּ��� (�⺻�� 10, �ִ� 100)
set /p user_ckpt= ���� �Է� �� ���� : 
if "%user_ckpt%" == "" (
set user_ckpt=10
echo.
...
:stt3
echo ���� �ѹ��� �н��� batch ���� �Է����ּ��� (�⺻�� 8, �ִ� 128)
set /p user_max_sentences= ���� �Է� �� ���� : 
...
call start cmd /C tensorboard --logdir "%dpath%\checkpoint\%user_name%\lightning_logs\lastest"
...
echo hubert_path: checkpoint/hubert/hubert_soft.pt >> training/config_nsf.yaml
...
echo pe_ckpt: checkpoint/0102_xiaoma_pe/model_ckpt_steps_60000.ckpt >> training/config_nsf.yaml
...
echo vocoder_ckpt: checkpoint/nsf_hifigan/model >> training/config_nsf.yaml
