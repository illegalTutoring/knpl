...
class BaseTrainer:
    ...
    def restore_state_if_checkpoint_exists(self, model):
        ...
        # find last epoch
        checkpoint = os.listdir(self.checkpoint_callback.filepath)
    ...
    def restore_training_state(self, checkpoint):
        ...
        if self.checkpoint_callback is not None and self.checkpoint_callback is not False:
            # return allowing checkpoint with meta information (global_step, etc)
    ...
    def _atomic_save(self, checkpoint, filepath):
        """Saves a checkpoint atomically, avoiding the creation of incomplete checkpoint.
