...
4. C++ 14.x 버전 설치
    - 선택항목들 설치
      ![이미지](./C14.png)
5. checkpoint 다운로드
    - [**HubertSoft**](https://github.com/bshall/hubert/releases/download/v0.1/hubert-soft-0d54a1f4.pt)<br>인코더를 다운로드 받아서 `pretrain/hubert` 폴더에 저장
    - [**DiffSinger Community Vocoders Project**](https://openvpi.github.io/vocoders)<br>최하단의 링크를 통해 nsf_hifigan_20221211.zip을 `pretrain/` 폴더에 압축 해제

# 학습

<details close>
<summary>모델 학습을 위한 가이드(<strong>TLDR</strong>)</summary>
...
# 추론
    ...
    ```
    'model_path'            :   'exp/combsub-test/model_best.pt', # 추론 모델의 위치
    'input'                 :   'data/train/audio/video-0000.wav', # 추론을 진행하려는 Input 데이터 위치
